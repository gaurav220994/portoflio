    ...
    >
      <Tip content='Connect with me on Linkedin'>
        <LinkedinOption
          ...
          onClick={() => {
            raiseEvent('Linkedin', 'Linkedin', 'Linkedin');
      ...
      <Tip content='Collaborate with me on Github'>
        <Github
          style={{ cursor: 'pointer' }}
          onClick={() => {
            raiseEvent('Github', 'Github', 'Github');
      ...
      <Tip content='Contact me on: gv.agarwal94@gmail.com'>
        <MailOption
          style={{ cursor: 'pointer' }}
          onClick={() => {
            raiseEvent('Mail', 'Mail', 'Mail');
            window.open('mailto:gv.agarwal94@gmail.com', '_blank');
          }}
        />
      </Tip>
      <Tip content='Like me on Facebook'>
        <FacebookOption
          style={{ cursor: 'pointer' }}
          onClick={() => {
            raiseEvent('Facebook', 'Facebook', 'Facebook');
      ...
      <Tip content='Follow me on Instagram'>
        <Instagram
          style={{ cursor: 'pointer' }}
          onClick={() =>{
            raiseEvent('Instagram', 'Instagram', 'Instagram');
